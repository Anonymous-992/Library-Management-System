      ...
      <div className="top">
        <div className="box1">
          <div className="logo text__primary">
            ...
            <h4>UAJK Neelum Campus Library</h4>
          </div>
          <p style={{ marginTop: "8px", lineHeight: "1.5rem" }}>
            Gateway to knowledge, discovery, and lifelong learning for all UAJK
        ...
        <div className="box4">
          ...
          <div className="item">
            ...
            <span>UAJK Neelum Campus, Athmuqam</span>
          </div>
          <div className="item">
            <AiOutlineMail className="icon" />
            <span>uajk@gmail.com</span>
          </div>
          <div className="item">
            <AiOutlinePhone className="icon" />
            <span>923558151117</span>
          </div>
        </div>
      </div>
      <div className="bottom">
        <span>
          &copy;2023 Copyright : UAJK Library Management System, Neelum
        </span>
      </div>
    </footer>
  );
