    ...
    <div className="bg text__color">
      ...
      <section className="welcome">
        <div className="left">
          ...
          <p>
            Welcome to the UAJK Neelum Campus Library Management
            System !
          </p>
          <p>
            This Library Management System  is a modern, fully digital solution designed to meet the evolving needs of libraries in academic institutions. It serves as an intelligent information management platform that simplifies daily operations and enhances accessibility for students, teachers, and administrators. The system supports both physical and digital collections, enabling seamless book management, borrowing, and tracking through a single platform.It aims to create an efficient, paperless, and collaborative library environment that encourages learning, research, and resource sharing. It combines convenience, accuracy, and automation to deliver a smarter and more engaging library experience
          </p>
        </div>
